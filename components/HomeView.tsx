...
function NeonTube({ color, height, delay = '0s', flicker = false }: {
  ...
  return (
    <div style={{
      ...
      boxShadow: `0 0 5px 1px ${color}88, 0 0 14px 3px ${color}44`,
      animation: flicker
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <NeonTube color="#ff2d78" height={70} delay="0s" flicker />
        <NeonTube color="#c9a227" height={50} delay="0.5s" />
        <NeonTube color="#00d4ff" height={90} delay="1s" />
        <NeonTube color="#c9a227" height={35} delay="1.5s" flicker />
        <NeonTube color="#ff2d78" height={100} delay="0.3s" />
        <NeonTube color="#a855f7" height={60} delay="2s" flicker />
        <NeonTube color="#00d4ff" height={45} delay="0.8s" />
        <NeonTube color="#c9a227" height={80} delay="1.3s" />
        <NeonTube color="#ff2d78" height={55} delay="0.6s" flicker />
        <NeonTube color="#a855f7" height={40} delay="1.8s" />
      </div>
...
function ChromeStrip({ height = 8, opacity = 1 }: { height?: number; opacity?: number }) {
  return (
    <div style={{ height, width: '100%', flexShrink: 0, background: chromeH, opacity }} />
  )
}
    ...
    <div style={{
      ...
      {Array.from({ length: rows * cols }).map((_, i) => (
        <div key={i} style={{
          ...
          boxShadow: '0 0 2px rgba(201,162,39,0.15)',
        }} />
      ))}
    </div>
  )
  ...
  return (
    <div style={{ textAlign: 'center', lineHeight: 1 }}>
      <div style={{
        ...
        color: 'rgba(201,162,39,0.55)', fontFamily: 'monospace', marginBottom: 4,
      }}>
        ♪ welcome to ♪
      </div>
      ...
      <div style={{
        ...
        color: 'rgba(201,162,39,0.4)', fontFamily: 'monospace', marginTop: 5,
      }}>
        ── jukebox ──
      </div>
    </div>
    ...
    <div className="h-full flex flex-col overflow-hidden" style={{ color: 'var(--retro-cream)' }}>
      ...
      <div style={{ flexShrink: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
            ...
            <span style={{ fontSize: 9, color: 'rgba(201,162,39,0.3)', letterSpacing: '0.1em', fontFamily: 'monospace', textTransform: 'uppercase' }}>
              insert coin
            </span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
            ...
            <button
              ...
              style={{ color: 'rgba(201,162,39,0.35)', padding: 4 }}
            >
      ...
      {query ? (
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* ── Full vinyl (600px, top half visible) ── */}
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, marginBottom: 16 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'var(--retro-gold)', color: '#0e0800',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  boxShadow: '0 0 16px rgba(201,162,39,0.45), 0 3px 10px rgba(0,0,0,0.7)',
                  border: '3px solid rgba(255,240,180,0.3)',
                  flexShrink: 0,
              ...
              >
                {isPlaying ? (
                  <svg width="26" height="26" viewBox="0 0 18 18" fill="currentColor">
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span className="font-typewriter" style={{ fontSize: 11, color: 'rgba(201,162,39,0.45)', letterSpacing: '0.22em', textTransform: 'uppercase' }}>
                stereo hi-fi
              </span>
            </div>
            <SpeakerGrille rows={3} cols={12} />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 52px 0' }}>
            ...
            <span className="font-retro" style={{ fontSize: 15, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--retro-gold)', opacity: 0.5 }}>
              Select a Track
            </span>
            <div style={{ flex: 1, height: 1, background: 'rgba(201,162,39,0.15)' }} />
          </div>
          ...
          {queue.length > 0 && (
            <div style={{ padding: '12px 44px 16px' }}>
              <p className="font-typewriter" style={{ fontSize: 13, textTransform: 'uppercase', marginBottom: 10, color: 'var(--retro-muted)', letterSpacing: '0.08em' }}>
                Up Next
              </p>
                ...
                {queue.slice(0, 8).map((track, i) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p style={{ fontSize: 15, fontWeight: 500, color: 'var(--retro-cream)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {track.name}
                      </p>
                      <p style={{ fontSize: 13, color: 'var(--retro-muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {track.artists.map(a => a.name).join(', ')}
                      </p>
                    </div>
                    <span className="font-typewriter" style={{ fontSize: 13, color: 'var(--retro-muted)', flexShrink: 0 }}>
          ...
          <div style={{ padding: '12px 44px 14px' }}>
            <p className="font-typewriter" style={{ fontSize: 13, textTransform: 'uppercase', marginBottom: 14, color: 'var(--retro-muted)', letterSpacing: '0.08em' }}>
              Recently Played
            </p>
            {loading ? (
              ...
              <div className="scrollbar-none" style={{ display: 'flex', gap: 14, overflowX: 'auto', paddingBottom: 8, margin: '0 -44px', padding: '0 44px' }}>
                {recentTracks.map((track) => (
                  ...
                  >
                    <div style={{
                      width: 150, height: 150, borderRadius: 10, overflow: 'hidden', marginBottom: 8,
                    ...
                    <p style={{ fontSize: 14, fontWeight: 500, color: 'var(--retro-cream)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {track.name}
                    </p>
                    <p style={{ fontSize: 13, color: 'var(--retro-muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {track.artists.map(a => a.name).join(', ')}
